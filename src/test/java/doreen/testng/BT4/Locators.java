...
public class Locators {
    ...
    public String resultList = "//tbody/tr/td[2]";
    ...
    // product
    public String addNewProductMenu = "//span[normalize-space()='Products']/ancestor::li//ul//li//span[normalize-space()='Add New product']";
    public String productName = "//input[@placeholder='Product Name']";
    public String productCategory = "//div[@id='category']//button[@data-id='category_id']";
    public String productCategorySearch = "//div[@id='category']//div[@class='bs-searchbox']/input";
    public String productUnit = "//input[@name='unit']";
    public String productTags = "//label[normalize-space()='Tags *']/span";
    public String productColorToggle = "//h5[normalize-space()='Product Variation']/parent::div//following-sibling::div[@class='card-body']//div[@class='col-md-1']//span";
    public String productColor = "//button[@data-id='colors']";
    public String productColorSearch = "//select[@id='colors']/following-sibling::div[@class='dropdown-menu show']/div[@class='bs-searchbox']/input";
    public String productUnitPrice = "//input[@placeholder='Unit price']";
    public String productSelectedColor = "//div[@id='sku_combination']//tbody/tr/td/label";
    public String savePublishBtn = "//button[normalize-space()='Save & Publish']";
}
